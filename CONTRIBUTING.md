# Contributing to the Unicorn Theme
...
Always try your best to make a positive impact on this project and its community. By participating, you are expected to uphold the [Code of Conduct](CODE_OF_CONDUCT.md). Please report any unacceptable behavior to hello@unicornagency.com.
...
Before you open a new issue, check to see if the problem has [already been reported](https://github.com/Unicorn/vs-theme-unicorn/issues). If it has and **the issue is still open**, add a comment to the existing issue instead of creating a new one.
...
For complex and/or broad issues such as language support, consider creating a short demo like the ones found in [demos](https://github.com/Unicorn/vs-theme-unicorn/tree/master/demos). Creating a demo is incredibly helpful and will speed up the development process.
...
If you've fixed a bug, started working on an enhancement, or done something else, you can [create a pull request](https://github.com/Unicorn/vs-theme-unicorn/pulls) to start a conversation about your changes.
...
5. [**Open a pull request**](https://github.com/Unicorn/vs-theme-unicorn/pulls) to merge your branch into `master`.
